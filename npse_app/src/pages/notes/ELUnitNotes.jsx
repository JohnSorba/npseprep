...
import { getEnglishSubjectById, getEnglishUnitById } from '../../data/englishLanguageNotes';
import { getEnglishNotesContent } from '../../data/englishNotesContent';
import { getEnglishNotesContentPart2 } from '../../data/englishNotesContentPart2';
import { getEnglishNotesContentPart3 } from '../../data/englishNotesContentPart3';
import { getEnglishNotesContentPart4 } from '../../data/englishNotesContentPart4';
...
const ELUnitNotes = () => {
    ...
    const subject = getEnglishSubjectById(subjectId);
    const unit = getEnglishUnitById(subjectId, unitId);
    // Get content from all parts
    const content = getEnglishNotesContent(unitId) || getEnglishNotesContentPart2(unitId) || getEnglishNotesContentPart3(unitId) || getEnglishNotesContentPart4(unitId);
        ...
        return (
            <section className="section">
                <div className="container" style={{ textAlign: 'center' }}>
                    ...
                    <Link to="/notes/english-language" className="btn btn-primary">
        ...
        <div className="notes-page-wrapper">
            ...
            <aside className="notes-toc-sidebar">
                ...
                <div className="sidebar-cta-card">
                    ...
                    <div className="sidebar-cta-text">
                        Try our vocabulary builder for English Language.
                    </div>
            ...
            <main className="notes-content-main">
                ...
                <nav className="notes-breadcrumb">
                    <Link to="/">Home</Link>
                    <span>›</span>
                    <Link to="/notes/english-language">English Language</Link>
                    <span>›</span>
                    <Link to={`/notes/english-language/${subject.id}`}>{subject.name}</Link>
                    <span>›</span>
                ...
                <div className="quiz-cta-block">
                    ...
                    <Link to="/quiz/english" className="quiz-cta-btn">
                        Take Topic Quiz
                        <ArrowRightIcon />
                    </Link>
                </div>
                ...
                <nav className="notes-bottom-nav">
                    {prevUnit ? (
                        <Link to={`/notes/english-language/${subject.id}/${prevUnit.id}`} className="nav-link-prev">
                            <ArrowLeftIcon />
                            Previous Topic
                        </Link>
                    ) : (
                    ...
                    {nextUnit ? (
                        <Link to={`/notes/english-language/${subject.id}/${nextUnit.id}`} className="nav-link-next">
                            Next Topic
                            <ArrowRightIcon />
                        </Link>
                    ) : (
                        <Link to="/quiz/english" className="nav-link-next">
                            Take Quiz
                            <ArrowRightIcon />
                        </Link>
                    )}
