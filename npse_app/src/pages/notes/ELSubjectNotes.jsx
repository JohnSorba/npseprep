...
import { getEnglishSubjectById, englishLanguageSubjects } from '../../data/englishLanguageNotes';

const ELSubjectNotes = () => {
    ...
    return (
        <>
            ...
            <section className="page-hero">
                <div className="container">
                    <div className="breadcrumbs" style={{ color: 'rgba(255,255,255,0.7)' }}>
                        ...
                        <span>›</span>
                        <Link to="/notes/english-language" style={{ color: 'rgba(255,255,255,0.7)' }}>English Language</Link>
                        <span>›</span>
                ...
                <div className="container">
                    ...
                    <div className="units-grid">
                        {subject.units.map((unit, index) => (
                            <Link
                                to={`/notes/english-language/${subject.id}/${unit.id}`}
                                key={unit.id}
                                className="unit-card"
            ...
            <section className="section" style={{ background: 'white' }}>
                <div className="container">
                    ...
                    <div style={{
                        ...
                        <Link to="/notes/english-language" className="btn btn-outline btn-lg">
                            ← Back to English Language
                        </Link>
                    </div>
                </div>
            ...
            <section className="section">
                <div className="container">
                    <div className="section-header">
                        <h2>Explore Other Subject Areas</h2>
                    </div>
                    <div className="notes-subject-mini-grid">
                        {englishLanguageSubjects
                            .filter(s => s.id !== subject.id)
                            .map((s) => (
                                <Link
                                    to={`/notes/english-language/${s.id}`}
                                    key={s.id}
